...
#
tsh> ./mysplit 4
Job [1] (1506) terminated by signal 2
tsh> /bin/ps a
  ...
  582 tty1     Sl     0:15 /home/red/.vscode-server/bin/b37e54c98e1a74ba89e03073e5a3761284e3ffb0/node /home/red/.vscode-server/bin/b37e54c98e1a74ba89e03073e5a3761284e3ffb0/out/vs/server/main.js  --port=0 --fileWatcherPolling=0
 ...
 1501 pts/0    S      0:00 make test11
 1502 pts/0    S      0:00 /bin/sh -c ./sdriver.pl -t trace11.txt -s ./tsh -a "-p"
 1503 pts/0    S      0:00 /usr/bin/perl ./sdriver.pl -t trace11.txt -s ./tsh -a -p
 1504 pts/0    S      0:00 ./tsh -p
 1515 pts/0    R      0:00 /bin/ps a
